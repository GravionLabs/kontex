import type { Provider, Tier, ContextSize } from '../types.js';
...
export const MODEL_ROSTER: Record<Provider, Record<Tier, string>> = {
  ...
  opencode: { fast: 'opencode/deepseek-v4-flash-free', balanced: 'opencode/deepseek-v4-flash', powerful: 'opencode/claude-sonnet-4-6' },
};
